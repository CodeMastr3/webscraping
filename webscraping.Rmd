...
read_class_schedule <- function(url) {
  ...
  returned <- tibble(subject= subject, catNum= catNum, sect= sect, type=type, title=title, units=units, instruct=instruct, totenro=totenro, sem= c(yearSem$strings[[1]][1,2]), year=yearSem$strings[[1]][1,3])
